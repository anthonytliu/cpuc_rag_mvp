...
class TestHybridProcessing:
    ...
    def test_agent_evaluation_logging(self):
        ...
        # Agent evaluation disabled - this test is skipped
        ...
        # Agent evaluation disabled - this functionality is skipped
